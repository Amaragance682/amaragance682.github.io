...
var upperLeftLegRotationAngle = -70.0;
var upperRightLegRotationAngle = 70.0;
var upperLeftArmRotationAngle = -70.0;
var upperRightArmRotationAngle = 70.0;



var upperLeftLegDirection = 1.0;
var upperRightLegDirection = 1.0;
var upperLeftArmDirection = 1.0;
var upperRightArmDirection = 1.0;
//-------------------------------------------
...
function initNodes(Id) {
    ...
    case leftUpperArmId:
        ...
        m = mult(m, rotateX(upperLeftArmRotationAngle + 180));
    ...
    case rightUpperArmId:
        ...
        m = translate(torsoWidth+upperArmWidth, 0.9*torsoHeight, 0.0);
        m = mult(m, rotateX(upperRightArmRotationAngle+ 180));
    ...
    case leftUpperLegId:
        ...
        m = mult(m , rotateX(upperLeftLegRotationAngle+ 180));
    ...
    case rightUpperLegId:
        ...
        m = translate(torsoWidth+upperLegWidth, 0.1*upperLegHeight, 0.0);
        m = mult(m, rotateX(upperRightLegRotationAngle+ 180));
...
var render = function() {
    ...
    upperLeftLegRotationAngle += upperLeftLegDirection * 1.0;
    upperRightLegRotationAngle += upperRightLegDirection * 1.0;
    upperLeftArmRotationAngle += upperLeftArmDirection * 1.0;
    upperRightArmRotationAngle += upperRightArmDirection * 1.0;

    if (upperLeftLegRotationAngle > 70.0 || upperLeftLegRotationAngle < -70.0) {
        upperLeftLegDirection *= -1.0;
    }
    if (upperRightLegRotationAngle > 70.0 || upperRightLegRotationAngle < -70.0) {
        upperRightLegDirection *= -1.0;
    }
    if (upperLeftArmRotationAngle > 70.0 || upperLeftArmRotationAngle < -70.0) {
        upperLeftArmDirection *= -1.0;
    }
    if (upperRightArmRotationAngle > 70.0 || upperRightArmRotationAngle < -70.0) {
        upperRightArmDirection *= -1.0;
    }
